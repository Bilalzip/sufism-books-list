    ...
    <div className="max-w-5xl mx-auto px-6 py-10">
      <div className="mb-6">
        <Link
          ...
          font-medium text-gray-700 hover:bg-black hover:text-white transition"
        >
          Back
        </Link>
      </div>
          ...
          <div className="p-8">
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="border rounded-xl p-4">
                ...
                <p className="font-medium text-black">{book.author}</p>
              </div>

              <div className="border rounded-xl p-4">
                <p className="text-gray-500 mb-1">Year</p>
                <p className="font-medium text-black">{book.year}</p>
              </div>
            </div>
            ...
            <div className="mt-8">
              <Link
                to={`/edit/${book.id}`}
                className="inline-flex items-center rounded-md bg-black 
                px-4 py-2 text-sm font-medium text-white hover:opacity-90 transition"
              >
                Edit Book
              </Link>
            </div>
